...
export const courses: Course[] = [
  ...
  },
  {
    ...
    description:
      "Programa integral de 16 horas diseñado para dominar Microsoft Copilot y Copilot Studio de extremo a extremo. Aprende a construir asistentes personalizados, integrarlos con flujos low-code y automatizar procesos analíticos de negocio.",
    ...
    syllabus: [
      {
        module: "Módulo 1: Introducción práctica a Copilot y Copilot Studio",
        topics: [
          "Qué es Microsoft Copilot y su rol en la empresa y M365 (Outlook, Excel, Word, PowerPoint)",
          "Copilot Studio como herramienta estándar corporativa",
          "Casos de uso reales en áreas de proyectos e informática",
          "Limitaciones, buenas prácticas y gobernanza",
          "Arquitectura de un agente en Copilot Studio (componentes, flujos, conectores, acciones)",
          "Integración con Microsoft 365, Power Platform y APIs internas",
          "Seguridad, permisos y entornos",
        ],
        hours: 4,
      },
      {
        module: "Módulo 2: Construcción de Asistentes Inteligentes",
        topics: [
          ...
          "Uso de fuentes internas (SharePoint, SQL, APIs)",
          "Taller práctico: Asistente para el área de proyectos (seguimiento de hitos, consulta de estados de proyectos y generación automática de reportes)",
        ],
        hours: 4,
      },
      {
        module: "Módulo 3: Automatización y LowCode con Copilot Studio",
        topics: [
          "Integración con Power Automate: flujos automatizados y triggers desde agentes",
          "Automatización de tareas repetitivas",
          "Acciones personalizadas y lógica empresarial: llamadas a APIs, condiciones, bucles, errores y reglas de negocio",
          "Taller práctico: Automatización de procesos internos (solicitudes de soporte, gestión de aprobaciones y notificaciones inteligentes)",
        ],
        hours: 4,
      },
      {
        module: "Módulo 4: Análisis de Datos y Herramientas Avanzadas",
        topics: [
          "Copilot + Datos: análisis con Copilot, consultas en lenguaje natural e integración con Power BI",
          "Monitoreo, métricas, evaluación de calidad conversacional y optimización continua de agentes",
          "Taller práctico: Agente analítico (consultas a bases de datos, generación de insights y resúmenes automáticos para gerencia)",
        ],
        hours: 4,
      },
    ],
