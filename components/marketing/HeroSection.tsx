...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden pt-4 pb-10 lg:pt-6 lg:pb-20">
      {/* Bg decorations */}
      ...
      <div className="max-w-[1400px] mx-auto px-5 lg:px-8 relative z-10 py-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left">
            {/* Pill Badge */}
            <FadeIn delay={0}>
              <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-red-50 border border-red-150 text-red-600 text-xs sm:text-sm font-black mb-8 animate-pulse">
                <span className="relative flex h-3 w-3">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75" />
                  <span className="relative inline-flex rounded-full h-3 w-3 bg-red-600" />
                </span>
                ⚡ ¡CYBER DAY PROGRAMBI! — HASTA 60% DCTO ⚡
              </div>
            </FadeIn>
            ...
            {/* Subtitle */}
            <FadeIn delay={0.3}>
              <p className="text-lg lg:text-2xl text-gray-500 mb-8 font-light leading-relaxed max-w-2xl mx-auto lg:mx-0">
            ...
            {/* Countdown timer */}
            <FadeIn delay={0.38}>
              <div className="bg-white/95 border-2 border-red-500/20 rounded-3xl p-6 mb-8 max-w-xl mx-auto lg:mx-0 shadow-[0_20px_50px_rgba(239,68,68,0.18)] relative overflow-hidden backdrop-blur-md text-left">
                ...
                <div className="flex items-center justify-between mb-4 relative z-10">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-[11px] font-black text-red-600 tracking-wider uppercase">El Cyber Day finaliza en:</p>
                  </div>
                  <span className="text-[9px] font-black text-red-600 bg-red-50 border border-red-100 px-2.5 py-0.75 rounded-full uppercase tracking-wider">CUPOS LIMITADOS</span>
                </div>
            ...
            <FadeIn delay={0.45}>
              <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start">
                ...
                <Link
                  href="/cursos"
                  className="px-8 py-5 sm:px-10 sm:py-6 rounded-2xl bg-white text-gray-700 font-bold text-xl sm:text-2xl border-2 border-gray-100 hover:border-red-500 hover:text-red-500 transition-all flex items-center justify-center gap-4 no-underline hover:-translate-y-1"
                >
