...
export default function PythonSyllabus({ selectedLevel, hideSelector = false, cleanLayout = false }: { selectedLevel?: number; hideSelector?: boolean; cleanLayout?: boolean }) {
        ...
        {!hideSelector && !cleanLayout && (
          ...
          <div className="inline-flex bg-gray-50/80 p-1 rounded-full border border-gray-200/60 shadow-sm backdrop-blur-md w-full max-w-4xl overflow-x-auto scrollbar-hide flex-nowrap gap-1 sm:p-1.5 sm:gap-2 sm:w-auto">
            ...
            >
              ...
              <span className="text-[8px] sm:text-[10px] uppercase tracking-wider mt-0.5 sm:mt-1 opacity-60 whitespace-nowrap">Análisis & Viz (16h)</span>
            </button>
            ...
            >
              ...
              <span className="text-[8px] sm:text-[10px] uppercase tracking-wider mt-0.5 sm:mt-1 opacity-60 whitespace-nowrap">Data Science & AI (16h)</span>
            </button>
          </div>
        </div>
        )}
