...
export default function PowerBiSyllabus({ selectedLevel, hideSelector = false, cleanLayout = false }: { selectedLevel?: number; hideSelector?: boolean; cleanLayout?: boolean }) {
        ...
        {!hideSelector && !cleanLayout && (
          ...
          <div className="inline-flex bg-gray-50/80 p-1 rounded-full border border-gray-200/60 shadow-sm backdrop-blur-md w-full max-w-4xl overflow-x-auto scrollbar-hide flex-nowrap gap-1 sm:p-1.5 sm:gap-2 sm:w-auto">
            ...
            >
              ...
              <span className="text-[8px] sm:text-[10px] uppercase tracking-wider mt-0.5 sm:mt-1 opacity-60 whitespace-nowrap">Análisis y DAX (16h)</span>
            </button>
            ...
            >
              ...
              <span className="text-[8px] sm:text-[10px] uppercase tracking-wider mt-0.5 sm:mt-1 opacity-60 whitespace-nowrap">Avanzado & AI (16h)</span>
            </button>
          </div>
        </div>
        )}
          ...
          {activeTab === "nivel1" && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="grid md:grid-cols-5 gap-6 mb-10">
                <div className="md:col-span-2 bg-white p-5 sm:p-8 rounded-2xl sm:rounded-[2rem] border border-gray-100 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.03)] relative overflow-hidden group hover:border-blue-100 transition-colors">
                ...
                <div className="md:col-span-3 bg-gradient-to-br from-blue-50/40 to-white p-5 sm:p-8 rounded-2xl sm:rounded-[2rem] border border-blue-100/50 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.02)]">
              ...
              <div className="space-y-3">
                {[
                  { num: 1, title: "Introducción a Power BI (2 horas)", items: ["¿Qué es Power BI?", "¿Qué aprenderemos durante el curso?", "Obteniendo tu cuenta de Power BI.", "Instalaciones necesarias."] },
                  ...
                  { num: 3, title: "Visualizaciones Básicas y Dashboards Iniciales (6 horas)", items: ["Guardando y Editando un Informe.", "Creando una Gráfica de Distribución.", "Utilizando Gráficos de Mapa y Saturación de Color.", "Agregar Gráficas de Pastel y Utilizando Filtros Relacionados.", "Gráficas de Dispersión.", "Medidores, Tablas y Tarjetas.", "Creación de KPIs básicos para visualizarlos en el dashboard."] },
