...
export function IntroReceivedEmail({
  referrerName,
  prospectName,
  prospectCompany,
  panelUrl,
  ...
  return (
    <Html lang="es">
      <Head />
      <Preview>
        Recibimos tu intro de {prospectName} · {prospectCompany}
      </Preview>
      <Body style={body}>
        <Container style={box}>
          <Text style={kicker}>ProgramBI · Referidos</Text>
          <Heading style={h1}>Intro recibida</Heading>
          <Text style={p}>Hola {referrerName},</Text>
          <Text style={p}>
            Recibimos tu intro de <strong>{prospectName}</strong> en {prospectCompany}.
            El equipo la revisa antes de calificarla — no es un programa de links para spamear.
          </Text>
